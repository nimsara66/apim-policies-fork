...
public class IntegrationGuardrailConstants {
    ...
    public static String REQUEST_PAYLOAD_KEY = "requestPayload";
    public static String RESPONSE_PAYLOAD_KEY = "responsePayload";
