...
public class RAGInjector extends AbstractMediator implements ManagedLifecycle {
    ...
    private void findAndTransformPayload(MessageContext messageContext) throws AxisFault {
        ...
        // Regex to find rag://<rag-injector-name>?<params>
        String regex = RAGInjectorConstants.RAG_INJECTOR_REGEX.replaceFirst("<rag-injector-name>", this.name);
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                if (!Objects.equals(injectorName, this.name)) return;
                ...
                String resolvedPrompt = promptTemplates
                        .get("injectTemplate")
